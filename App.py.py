...
def predict():
    ...
    if result == 'Normal' :
        ...
        return render_template('insomnia.html', result=result, nama=nama)
    else:
...
@app.route('/infosleepapnea')
def infosleepapnea():
    return render_template('infosleepapnea.html')

@app.route('/infoinsomnia')
def infoinsomnia():
    return render_template('infoinsomnia.html')

@app.route('/infosleepdisorder')
def infosleepdisorder():
    return render_template('infosleepdisorder.html')
